...
class ShiJianGuanLi(object):
    ...
    def get_book_msg(self):
        ...
        for url in self.book_url:
            ...
            for book in book_list:
                # 获取每段音频的名称和地址
                list = {}
                list['name'] = str(book['index']) +'-'+ book['trackName'] if book['index'] >= 10 else '0'+str(book['index']) +'-'+ book['trackName']
                list['src'] = book['src']
                # 打印list
                print(list)
    ...
    def save(self, all_list):
        ...
        for i in all_list:  # i实际就是每个音频的名字和url
            ...
            dir = "/Users/free.hao/教程喜马拉雅/{}/".format(self.book_name)
            # 检查是否有相应的文件夹并创建目录
...
if __name__ == '__main__':
    sjgl = ShiJianGuanLi("帮您的孩子爱上学习", "16692347")
    sjgl.run()
```